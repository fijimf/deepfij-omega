...
public class WonLost implements AnalyticModel {
    ...
    private final String modelName = "WonLost";
    private final Statistic wins = new Statistic("wins", "Wins", true, 0.0, "%.0f");
    private final Statistic losses = new Statistic("losses", "Losses", false, 0.0, "%.0f");
    private final Statistic wp = new Statistic("wp", "Win Pct", true, null, "%.4f");
    private final Statistic wStreak = new Statistic("wstreak", "Win Streak", true, 0.0, "%.0f");
    private final Statistic lStreak = new Statistic("lstreak", "Loss Streak", false, 0.0, "%.0f");
